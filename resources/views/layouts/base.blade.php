                                    ...
                                    <li class="onhover-dropdown">
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                ...
                                                @else
                                                <li>
                                                    <a href="{{route('user.index')}}" class="d-block">my-Accouny</a>
                                                </li>
                                                @endif
                                                <li>
                                                ...
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{('assetassets/images/fashion/product/front/1.jpg')}}"
                                        ...
                                        <div>
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{('assetassets/images/fashion/product/front/3.jpg')}}"
                                                                class="bg-img blur-up lazyload" alt="">
                                                        </a>
                                                    </div>
                                                </div>
