                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            <div>
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image ??'None'}}" 
                                                    class="img-fluid blur-up lazyload" alt="{{$product->name ??'None'}}">
                                            </div>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos">
                                            <div>
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image ??'None'}}"  
                                                class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->name ??'None'}}">
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="price-detail">
                                     ...
                                     <del>${{$product->regular_price ??'None'}}</del>
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <a href="javascript:void(0)"  onclick="event.preventDefault();documeent.getElementById('addtocart').submit();"                                          
                                    ...
                                    <div class="mt-2 mt-md-3 border-product">
                                        <h6 class="product-title hurry-title d-block">
                                            @if($product->stock_status ??'None'=='instock')
                                            Instock
                                            @else
                                            Out of stock
                                            @endif
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{route('shop.product.details',['slug'=>$rproduct->sulg])}}">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{route('shop.product.details',['slug'=>$rproduct->sulg])}}" class="font-default">
                                            <h5>{{$rproduct->name }}</h5>
                                        </a>
