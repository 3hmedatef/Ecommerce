        ...
        <div class="container">
            <div class="row">
                                        ...
                                        <ul class="category-list">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <p class="font-light">{{$category->name->count()}}</p>
                                                </div>
                                            </li>
                                            @endforeach
                                        </ul>
                ...
                <div class="category-product col-lg-9 col-12 ratio_30">
                    ...
                    <div
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="">
                                            <img src="{{asset('assets/images/fashion/product/back/20.jpg')}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                        ...
                        <div>
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    <div class="rating-details">
                                        <span class="font-light grid-content">{{protuct->Category->name}}</span>
                                        <ul class="rating mt-0">
                                            <li>
                                                <i class="fas fa-star theme-color"></i>
                                            </li>
                                    ...
                                    <div class="main-price">
                                        ...
                                        <div class="listing-content">
                                            <span class="font-light">{{protuct->category->name}}</span>
                    ...
                    {{$products->withQueryString()->links("pagination.defeult")}}
...
<script>
   $(function(){
    $("#pagesize").on("change",function(){
        $("#size").val($("pagessize option:selected").val());
        $("#frmFilter").submit();
